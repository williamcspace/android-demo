...
public class FieldDao extends AbstractDao<Field, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property MigrationId = new Property(2, Integer.class, "migrationId", false, "MIGRATION_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FIELD\" (" + //
                ...
                "\"NAME\" TEXT," + // 1: name
                "\"MIGRATION_ID\" INTEGER);"); // 2: migrationId
    }
    ...
    public Field readEntity(Cursor cursor, int offset) {
        Field entity = new Field( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2) // migrationId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Field entity, int offset) {
        ...
        entity.setMigrationId(cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2));
     }
