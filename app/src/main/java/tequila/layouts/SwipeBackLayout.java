...
import com.tangxinli.android.tequila.helpers.MethodInvoke;
import com.tangxinli.android.tequila.helpers.ViewDragHelper;
import com.tangxinli.android.tequila.managers.SwipeActivityManager;
import com.tangxinli.android.tequila.utils.AnimatorUtils;
import com.tangxinli.android.tequila.utils.LogUtils;
import com.tangxinli.android.tequila.utils.SDKVersionUtils;
import com.tangxinli.android.tequila.utils.SwipeTranslucentMethodUtils;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        try {
            LogUtils.d(TAG , "11111111111111111111111");
            if(mDragHelper.getViewDragState() != ViewDragHelper.STATE_DRAGGING) {
                LogUtils.d(TAG , "22222222222222222222222222");
                if (!mDragHelper.shouldInterceptTouchEvent(ev)) {
                    LogUtils.d(TAG , "33333333333333333333333333333333");
            ...
            LogUtils.d(TAG , "444444444444444444444444444444444");
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        LogUtils.d(TAG, "drawChild " + drawingTime);
    ...
    public void markTranslucent(boolean translucent) {
        LogUtils.i(TAG, "markTranslucent : " + translucent);
    ...
    public void computeScroll() {
        ...
        LogUtils.d(TAG, "computeScroll :: mScrimOpacity " + mScrimOpacity);
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback implements MethodInvoke.OnSwipeInvokeResultListener {
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            LogUtils.d(TAG, "tryCaptureView i :" + i + " ,edgeTouched:" + edgeTouched);
            return edgeTouched;
//        	return false;
        }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            LogUtils.i(TAG, "onViewReleased, xvel: " + xvel + " yvel: " + yvel + ", releaseLeft: " + left + ", releaseTop: " + top + ", translucent: " + mTranslucent);
            if (!mTranslucent) {
                return;
            }
...
//             int left = 0, top = 0;
        ...
        public void onViewDragStateChanged(int state) {
            ...
            LogUtils.d(TAG, "onViewDragStateChanged state " + state + "mTranslucent " + mTranslucent + " , requestedTranslucent " + mRequestTranslucent + " fastRelease " + mFastRelease);
            Activity mActivity = null;
            if (state == ViewDragHelper.STATE_DRAGGING) {
                LogUtils.d(TAG, "on drag");
            ...
            if (state == ViewDragHelper.STATE_DRAGGING /*&& mScrolling*/ && (SwipeBackLayout.this.getContext() instanceof Activity) && !mTranslucent && !mRequestTranslucent) {
                LogUtils.i(TAG, " match dragging");
                mTranslucent = true;
                mActivity = ((Activity) SwipeBackLayout.this.getContext());
                if (SDKVersionUtils.isGreaterorEqual(16)) {
                    LogUtils.w(TAG, "convertActivityToTranslucent::Android Version Error " + Integer.valueOf(Build.VERSION.SDK_INT));
                }
            }
            if (state == ViewDragHelper.STATE_SETTLING) {
                LogUtils.i(TAG, "notify settle, mReleasedLeft " + mReleasedLeft);
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            LogUtils.d(TAG, "onViewPositionChanged: Translucent : " + mTranslucent + "' ,left :"
            ...
            mContentTop = top;
            invalidate();
            LogUtils.d(TAG, "onViewPositionChanged: mScrollPercent : " + mScrollPercent + "' ,mIsScrollOverValid :" + mIsScrollOverValid);
        ...
        public int clampViewPositionHorizontal(View child, int left, int dx) {
            LogUtils.d(TAG, "clampViewPositionHorizontal : translucent : " + mTranslucent + " ,left " + left + " , dx " + dx);
            int ret = 0;
            if (mTranslucent) {
            ...
            LogUtils.d(TAG, "clampViewPositionHorizontal ret " + ret);
            return ret;
        }
        ...
        public void onSwipeInvoke(final boolean result) {
            LogUtils.d(TAG, "onSwipeInvoke :" + result);
            ECHandlerHelper.postRunnOnUI(new Runnable() {
                @Override
                public void run() {
                    LogUtils.i(TAG, "on Complete, result " + result + " ,releaseLeft " + mReleasedLeft);
                    if (result) {
                        if (mReleasedLeft > 0) {
                            SwipeActivityManager.notifySwipe(0.0F);
